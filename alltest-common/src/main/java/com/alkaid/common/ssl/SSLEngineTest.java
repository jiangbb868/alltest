...
public class SSLEngineTest {
     ...
     */
    private static String keyStoreFile = "F:\\RuiJie\\Relax\\program\\conf\\cer\\jetty.jks";
    private static String trustStoreFile = "F:\\RuiJie\\Relax\\program\\conf\\cer\\jetty.jks";
    private static String passwd = "relaxlf";
    ...
    private void getCipherSuites() {
        serverEngine = sslc.createSSLEngine();
        String[] cipherSuites = serverEngine.getEnabledCipherSuites();
        for (String ciperSuite : cipherSuites) {
            System.out.println(ciperSuite);
        }
    }
    /*
     * Run the demo.
